...
class MediaViewController: UIViewController {
    ...
    private func setupTableView() {
        ...
        mediaTableView.estimatedRowHeight = 521
        mediaTableView.rowHeight = UITableView.automaticDimension
        mediaTableView.dataSource = self
        mediaTableView.allowsSelection = true
    }
    ...
    private func updateView() {
        ...
        mediaTableView.isHidden = !hasPosts
    ...
    func loadUserPosts() {
        Api.HashTag.observeMedia { (post) in
...
// MARK: Segue Actions
extension MediaViewController: DetailTopicDelegate {
