...
class HomeViewController: UIViewController, UICollectionViewDataSource, UICollectionViewDelegate {
    ...
    override func motionBegan(_ motion: UIEvent.EventSubtype, with event: UIEvent?) {
        let alertController = UIAlertController(title: "Home", message: "Detected a device shake", preferredStyle: .alert)
    ...
    ///Navigation Bar
        func settingsBarButton() {
            ...
            button.setImage(UIImage(named: "Search.png"), for: UIControl.State.normal)
            button.addTarget(self, action: #selector(goToSearch), for: UIControl.Event.touchUpInside)
...
extension HomeViewController: UITableViewDataSource, UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.user = user
        cell.delegate = self
        cell.latLabel.text = "Location : (\(post.lat!), \(post.lng!))"
        return cell
    }
}
