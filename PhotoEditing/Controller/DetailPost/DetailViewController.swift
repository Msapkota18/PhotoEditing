...
class DetailViewController: UIViewController {
    ...
    func setNavButtons() {
        ...
        button.setImage(UIImage(named: "SaveInCell.png"), for: UIControl.State.normal)
        button.addTarget(self, action: #selector(savePost), for: UIControl.Event.touchUpInside)
